	...
	<div class="row">
		...
		<div class="col-lg-6">
			...
			<div class="summary entry-summary position-relative">
				...
				<h1 class="font-weight-bold text-7 mb-0"><a href="shop-product-full-width.html" class="text-decoration-none text-color-dark text-color-hover-primary">Porto Headphone</a></h1>
